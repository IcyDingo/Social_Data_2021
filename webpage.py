...
def load_data():
    ...
    return df_collis_copy, df_1, df_2, cnorm, boroughs_NY, districts1, df_3, df_4, df_5, df_6, temp, df_7, df_8, df_9, top10, df_10, df_11, df_12, df_13, df_14
...
df, df_1, df_2, cnorm, boroughs_NY, districts1,df_3, df_4, df_5, df_6, temp, df_7, df_8, df_9, top10, df_10, df_11, df_12, df_13, df_14= load_data() 
...
def app2():
    ...
    st.write("To begin with, the following 6 graphs describe the accidents that had injuries or deaths for the studied period. According to the first two graphs,  ")
