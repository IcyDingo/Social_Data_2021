...
fig22 = px.line(rain_data,x='i',y=['No Rain','Rain','Heavy Rain'],width=1700, height=500,title='The 24-7 cycle for Neighborhoods with increased number of collisions')
fig22.update_layout(xaxis_title="",yaxis_title="Collisions")
